...
<html lang="en">
    <head>
        ...
        <meta content="Djisamsoe Store Menjual berbagai macam hijab, jaket, aksesoris dan pakaian islami pria dan wanita" name="description">
    ...
    <body>
        <!-- navbar -->
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top" style="background-color: rgba(1, 1, 1, 0.8)">
            <div class="container">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon text-white pt-2"><i class="fas fa-bars"></i></span>
                </button>
                <div class="collapse navbar-collapse text-center text-white" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li>
                            ...
                            @else 
                                <a class="nav-link d-none" href="{{ url('login') }}">Login Admin</a>
                            @endif
                        </li>
                        <li>
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        <h4>Contact Us</h4>
                        <p class="pt-2">08:00 - 16:00 WIB / (Senin - Jumat)</p>
                        <p class="d-flex align-items-center"><i class="fas fa-envelope-square me-2"></i> {{ $profil->email }}</p>
                        <p class="d-flex"><i class="fas fa-map-marker-alt me-2 pt-2"></i>{{ $profil->address }}</p>
        ...
        <div class="copyright">
            <div class="container text-center">
                Copyright &copy; <?= date('Y');?> Djisamsoe Store Official <br>All Reserved
            </div>
        </div>
        <!-- end footer -->
        <!-- modal cari -->
