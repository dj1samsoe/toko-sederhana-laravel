...
@section('content')
    <div class="container" style="padding-top: 6rem">
        ...
        {{ alertbs_form($errors) }}
        <button type="button" class="btn btn-md" style="color: #fff; background-color: #b6895b" data-bs-toggle="modal" data-bs-target="#modelIdPlus">
            <i class="fas fa-plus mr-1"></i> Produk
        </button>
        <div class="card card-rounded mt-2">
            <div class="card-header" style="color: #fff; background-color: #b6895b">
                ...
                <div class="table-responsive mt-1">
                    <table class="table table-striped table-bordered" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$no}}</td>
                                <td><img src="{{asset('storage/'. $r->gambar)}}" class="img-fluid" style="width:80px;"></td>      
                                ...
                                <td>
                                    ...
                                    {{-- <form action="{{url("admin/produk/delete/$r->id")}}" method="POST" class="d-inline">
                                        @method('destroy')
                                        @csrf
                                        <button class="btn btn-danger btn-sm" onclick="javascript:return confirm(`Apakah anda yakin ingin menghapus produk ini?`);"><i class="fa fa-times"></i></button>
                                    </form>    --}}
                                    <a href="{{url("admin/produk/delete/$r->id")}}" 
                                        class="btn btn-danger btn-sm" 
                                        onclick="javascript:return confirm(`Apakah anda yakin ingin menghapus produk ini?`);" title="Delete">
